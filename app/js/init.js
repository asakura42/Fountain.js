...
$(document).ready(function(){
  ...
  $('#file-api').on('click', function() { LoadFileFromClick() } );
})


function LoadFileFromClick() {
...
function AddToolbarButtons() {
  ...
  $('#button-load').on('click', function() { LoadFileFromClick() } );
}
  ...
  clearTimeout(refresh)
    let html = `
      <section id="dock">
        <div class="container">
          <div id="file-api">
            <p>To parse a <a href="http://www.fountain.io">Fountain</a> screenplay document,<br/>simply drag the file into this box,<br/>or click it to browse for file.</p>
          </div>
        </div>
      </section>`
